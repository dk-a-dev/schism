...
/**
 * The signature Material 3 Expressive FAB menu: a morphing +/× toggle button that expands into
 * labeled pill actions ("Create group" / "Join group") instead of offering two separate, easily
 * confused entry points.
 */
